...
export default class Section8 extends Utilities {
    ...
    // private pagin: Element = document.querySelector(".S8__b")!;
    ...
    private _createBullets() {
        const { numOfSlides, /*pagin,*/ a } = this;
    ...
    private _setEvList() {
        ...
        // this._U_EventListSetter("focus", this._onFocus());
        // this._U_EventListSetter("blur", this._onBlur());
